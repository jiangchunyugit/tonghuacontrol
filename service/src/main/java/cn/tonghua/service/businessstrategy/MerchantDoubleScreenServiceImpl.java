 ...
 */
public class MerchantDoubleScreenServiceImpl implements BusinessStrategyService {

    @Override
    public BaseEvent analysis(FtpManager ftpManager) {
        return new MerchantDoubleScreenEvent(ftpManager.getLocalPath());
    }

    @Override
    public int getType() {
        return AnalysisStateEnum.MERCHANT_DOUBLE_SCREEN_81.getState();
    }
}
