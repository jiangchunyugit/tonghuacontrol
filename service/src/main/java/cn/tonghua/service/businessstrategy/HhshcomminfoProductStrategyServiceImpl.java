 ...
 */
public class HhshcomminfoProductStrategyServiceImpl implements BusinessStrategyService{

    @Override
    public BaseEvent analysis(FtpManager ftpManager) {
        return new HhshcomminfoProductEvent(ftpManager.getLocalPath());
    }

    @Override
    public int getType() {
        return AnalysisStateEnum.HHSHCOMMINFO_6_1.getState();
    }
}
